...
class ContactForm
{
    ...
    private function init()
    {
        ...
        $this->submitted = isset($_POST['contact_form_' . $this->form_index]);
    }
    ...
    public function setup_fields()
    {
        ...
        if (!isset($this->forms[$this->form_index])) {
            ...
            $this->fields[] = array(
                'type' => 'hidden',
                'name' => "contact_form_" . $this->form_index,
            );
    ...
    private function setup_templates()
    {
        ...
        if (!isset($this->templates[$this->template_index])) {
            ...
            // Set active template
            $this->template = $this->templates[$this->template_index];
        }
    }
    ...
    public function render()
    {
        ...
        if (count($this->errors) || !$this->submitted) {
            ...
            $form = array();
            $form['attr'] = 'action="' . $_SERVER['REQUEST_URI'] . '" method="post"';
    ...
    public function send_email()
    {
        ...
        $body = apply_filters('cgit_contact_email_body', $body, $this->form_index);
